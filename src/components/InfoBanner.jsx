    ...
    <div className="bg-blue-500 text-white py-4 overflow-hidden">
      <div className="container lg:max-w-[1200px] mx-auto w-[90%] md:w-5/6 flex flex-col md:flex-row items-center justify-between md:px-6">
        ...
        <div className="flex items-center space-x-4 md:space-x-6">
          ...
          <p className="text-[0.8rem] md:text-3xl font-semibold leading-tight font-Bricolage-Grotesque md:w-[42rem]">Since 2007 We’re working with Medical group more than 1200+ Patients</p>
        </div>
        ...
        <div className="mt-2 md:mt-0">
          <Link to="/contact" className="bg-white text-black hover:bg-blue-100 px-2 md:px-5 py-1 md:py-2 rounded-full flex items-center space-x-2">
            <span className='font-semibold font-Bricolage-Grotesque text-xs md:text-xl'>Contact Us</span>
