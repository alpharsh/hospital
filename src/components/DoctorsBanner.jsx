...
const DoctorsBanner = () => {
  return (
    <div className="flex items-center mt-6 justify-center bg-gradient-to-r from-[#8797FF] via-[#002570] to-[#8797FF] py-4  shadow-md">
      <div className="flex justify-between space items-center w-4/5 font-Bricolage-Grotesque">
