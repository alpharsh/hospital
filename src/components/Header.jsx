...
const Header = () => {
  return (
    <header className="bg-gradient-to-r fixed top-0 z-40 w-full bg-black/30 backdrop-blur-xl text-white py-1 md:py-2 px-8 shadow-lg rounded-bl-2xl rounded-br-2xl">
