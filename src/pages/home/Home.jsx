...
function Home() {
  return (
    <>
      {/* HERO SECTION */}
      <div className="relative flex items-center justify-between w-full h-screen bg-gradient-to-b from-[#002570] to-[#0074D1]">
        ...
        <div className="text-white  p-10 sm:pl-16 z-10">
          <h1 className="flex items-end font-Bricolage-Grotesque text-7xl font-bold leading-tight mb-4">
            We Provide Best <br />
            Healthcare <img src="/heart.png" alt="heart" className="absolute left-[30%]"/>
